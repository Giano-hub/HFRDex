exports.BattleMovedex = {
    ...
    attract: {
        ...
        contestType: "Cute",
        desc: "Causes the target to become infatuated, making it unable to attack 50% of the time. Pokemon with the Oblivious Ability or protected by the Aroma Veil Ability are immune.",
        shortDesc: "A target gets infatuated, disregards gender."
    },
    aurasphere: {
        num: 396,
        accuracy: true,
    ...
    thunderwave: {
        ...
        contestType: "Cool",
        desc: "Paralyzes the target. This move does not ignore type immunity. If an Electric-type Pokemon uses this move, the target cannot avoid the attack, even if the target is in the middle of a two-turn move.",
