...
var BattleLocationSearch = /** @class */ (function (_super) {
    ...
    BattleLocationSearch.prototype.moveIsNotUseless = function (id, species, moves, set) {
        var _a, _b, _c;
        var dex = this.dex;
        ...
        var moveData = BattleLocationdex[id];
        if (!moveData)
            return true;
    ...
    BattleLocationSearch.prototype.getBaseResults = function () {
        ...
        if (isSTABmons) {
            for (var id in this.getTable()) {
                ...
                var valid = false;
                for (var _f = 0, moveTypes_1 = moveTypes; _f < moveTypes_1.length; _f++) {
                    var type = moveTypes_1[_f];
        ...
        var usableMoves = [];
        var uselessMoves = [];
        for (var _g = 0, moves_1 = moves; _g < moves_1.length; _g++) {
            var id = moves_1[_g];
        ...
        for (var _h = 0, sketchMoves_1 = sketchMoves; _h < sketchMoves_1.length; _h++) {
            var id = sketchMoves_1[_h];
    ...
    BattleLocationSearch.GOOD_STATUS_MOVES = [
    ...
    BattleLocationSearch.GOOD_WEAK_MOVES = [
    ...
    BattleLocationSearch.BAD_STRONG_MOVES = [
    ...
    BattleLocationSearch.GOOD_DOUBLES_MOVES = [
